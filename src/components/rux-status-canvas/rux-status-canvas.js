...
export class RuxStatusCanvas extends LitElement {
  ...
  render() {
    return html`
      ...
      <canvas height="16" width="16" id="status" aria-label="${this.status}"></canvas>
    `;
  }
}

customElements.define('rux-status-canvas', RuxStatusCanvas);
